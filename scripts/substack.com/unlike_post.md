...
Automatically unlike Substack post on substack.com. Remove the logged-in account's like from a Substack post.

- Site: substack.com
- Address: `reduck/substack.com/unlike_post`
- Updated: 2026-08-14 (v1)
- Author: Reduck AI (reduck)

## Run it

Ask an AI agent connected to Reduck over MCP (`https://mcp.reduck.ai/mcp`) to run `reduck/substack.com/unlike_post`, or run it from a terminal:

```bash
npx @reduck-ai/cli@latest run --script reduck/substack.com/unlike_post
```
...
### What does "Unlike Substack post" do?

Remove the logged-in account's like from a Substack post.

### How do I automatically unlike Substack post on substack.com?
...
### Is there a substack.com API to unlike Substack post?

You do not need one. "Unlike Substack post" drives the real substack.com pages in a browser, so it works whether or not substack.com offers an API for this.
...
Source: https://reduck.ai/explore/scripts/reduck/substack.com/unlike_post
